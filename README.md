...
4. [Maching Learning Mastery](https://machinelearningmastery.com/start-here/)
5. [Repositorio antiguo del curso por Mauricio Quezada](https://github.com/mquezada/uchile-cc5206)
6. [Proyectos de años anteriores](https://prisma.dcc.uchile.cl/cursoMD/)
7. [Perfil de Hans Rosling en TED](https://www.ted.com/speakers/hans_rosling)
8. [Python Machine Learning book code repository](https://github.com/rasbt/python-machine-learning-book)
9. [Machine learning examples: A collection of machine learning examples and tutorials](https://github.com/lazyprogrammer/machine_learning_examples)
10. [KDnuggets: sitio Web muy popular sobre DM, ML, AI, etc](https://www.kdnuggets.com/)
11. [Centroid Initialization Methods for k-means Clustering - KDnuggets](https://www.kdnuggets.com/2020/06/centroid-initialization-k-means-clustering.html)
12. [Nested Cross-Validation for Machine Learning with Python](https://machinelearningmastery.com/nested-cross-validation-for-machine-learning-with-python/)
13. [Mathematics for Machine Learning](https://t.co/8ut4HxLMbE?amp=1)
14. [FAISS a library for very fast clustering](https://github.com/facebookresearch/faiss)
15. [Data Transformation: Standardization vs Normalization](https://www.kdnuggets.com/2020/04/data-transformation-standardization-normalization.html)
16. [Machine learning sucks at covid by Cory Doctorow](https://pluralistic.net/2021/08/02/autoquack/#gigo)
